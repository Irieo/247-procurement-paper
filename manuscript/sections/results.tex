...
A prominent observation in \cref{fig:10-hourly-annual.pdf} is that 100\% annual matching (or any other volumetric-based matching policy) has a proportionally smaller effect on a system decarbonisation than 24/7 hourly matching in 2030 compared to 2025. 
...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{plots/10/2030/DE/p1/system_capacity_diff.pdf}
    \caption{
