...
\begin{frontmatter}
	...
	\title{Navigating to a greener Europe with 24/7 hourly carbon-free electricity procurement}
...
This paper is an independent project, which is based on the third-party funded research work \cite{riepin-zenodo-systemlevel247}.
This research work was supported by a grant from Google Inc. 
...
This project is also developed as open-source. \url{https://github.com/PyPSA/247-cfe}
...
\section{Mathematical formulation of clean energy procurement}
\label{sec:si_3}
\input{sections/supplementary_3.tex}
